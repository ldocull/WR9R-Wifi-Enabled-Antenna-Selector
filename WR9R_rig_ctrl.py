...
def switch_change():
    if (selected_switch.get() == "Pos 1"):
        setWR9Rswitch("ONE", 0)
    if (selected_switch.get() == "Pos 2"):
        setWR9Rswitch("TWO", 0)
    if (selected_switch.get() == "Pos 3"):
        setWR9Rswitch("THREE", 0)
    if (selected_switch.get() == "Pos 4"):
        setWR9Rswitch("FOUR", 0)
    if (selected_switch.get() == "Pos 5"):
...
def station_service():
    ...
    if ((data!=last_data) and (len(data.decode())>=4) and (data[0]==ord('B')) and (data[1]==ord('N'))):
        ...
        setWR9R(data)
        print("bn:" + bandName)
        caption_label.config(text=bandName)
        last_data = data

    window.after(500, station_service)    
...
#  a variable to store the selected radio button value
selected_switch = tk.StringVar()
#  a frame to hold the radio buttons
switch_frame = tk.Frame(window)
switch_frame.pack(side="left", padx=20)
#  a set of radio-buttons that indicate the Wifi-Switch Positions
switch1 = tk.Radiobutton(switch_frame, text="POS-1", variable=selected_switch, value="Pos 1", command=switch_change)
switch1.pack()
switch2 = tk.Radiobutton(switch_frame, text="POS-2", variable=selected_switch, value="Pos 2", command=switch_change)
switch2.pack()
switch3 = tk.Radiobutton(switch_frame, text="POS-3", variable=selected_switch, value="Pos 3", command=switch_change)
switch3.pack()
switch4 = tk.Radiobutton(switch_frame, text="POS-4", variable=selected_switch, value="Pos 4", command=switch_change)
switch4.pack()
switch5 = tk.Radiobutton(switch_frame, text="POS-5", variable=selected_switch, value="Pos 5", command=switch_change)
switch5.pack()
